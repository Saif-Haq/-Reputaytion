...
AI aided Journalism simulator using OpenAI 
- Improve your interviewing skills by Interview Taylor Swift from 2017
- Get a print magazine version of your interview and be scored on your journalism skills


-> version 0.1:

maybe the journalism open ended questions are too hard i should give people two options and ditch the OpenAI thing because i don't have knowledge of fast api

- i should make a 2 questions choice questions on each round ????

-> version 0.2 let

lets make use of the AI SDK and repurpose it for my use case
